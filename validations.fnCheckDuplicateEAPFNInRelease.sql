...
-- Description:	Returns the list of EA Portal Friendly Names which are not unique for a particular release
--				More Information here: 
-- =============================================
ALTER FUNCTION [validations].[fnCheckDuplicateEAPFNInRelease] 
(
...
BEGIN
	...
	[Validation Name] = 'EA Portal Friendly Name should not be duplicated in a single release',	
	[Flagged Column Name] = 'EA Portal Friendly Name',
	[Flagged Column Value] = s.[EA Portal Friendly Name],							 
	[Remarks] = 'Duplicate EA Portal Friendly Name found',
	[SKU State] = s.[State],	
...
GROUP BY e.[Cayman Release],s.[EA Portal Friendly Name],s.ConsumptionSkuID,  e.ID, m.MeterID, s.[State], e.[SAP Rate Start Date], m.[Meter Status]
